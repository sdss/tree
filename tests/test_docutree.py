...
def test_docutree(app, status, warning):
    ...
    assert (
        '<h2>SDSS<a class="headerlink" href="#sdss" title="Link to this heading">¶</a></h2>' in tt
    )
    ...
    assert (
        '<li><p><span class="maroon">apogee_astronn</span>:  '
        "$APOGEE_ASTRONN/apogee_astroNN-{release}.fits</p></li>"
    ) in tt
